...
const AboutArtist = () => {
  ...
  return (
    <div className='col-span-6 row-span-3 col-start-7 row-start-10 bg-black p-4'>
      ...
      <div className='font-medium text-sm truncate mb-2'></div>
      <div className='text-xs text-muted-foreground truncate text-wrap mb-3'></div>
      <div className='font-[family-name:var(--font-geist-mono)] opacity-75'></div>
    </div>
  )
}
